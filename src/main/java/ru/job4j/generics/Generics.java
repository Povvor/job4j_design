...
public class Generics {
    public static void main(String[] args) {
        ...
        /*
          Так как ограничение сверху,
          убираем все что ниже Predator
         */
        ...
        /*
          Так как ограничение снизу,
          убираем все что выше Predator
         */
    ...
    public void printBoundedWildCard(List<? extends Predator> list) {
        ...
        /*
        Используем Lower Bounded Wildcard
